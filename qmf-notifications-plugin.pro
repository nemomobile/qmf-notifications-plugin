...
notifications_error_conf.files = x-nemo.email.error.conf
...
INSTALLS += target notifications_conf notifications_error_conf ts_install engineering_english_install
